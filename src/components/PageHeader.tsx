...
export function PageHeader({ title, subtitle, breadcrumb }: PageHeaderProps) {
  return (
    <section className="relative py-20 md:py-28 overflow-hidden" style={{ backgroundColor: '#EBB342' }}>
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-foreground rounded-full blur-3xl translate-x-1/2 translate-y-1/2" />
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          {subtitle && (
            <motion.p
              ...
              className="text-foreground/80 text-lg md:text-xl max-w-2xl mx-auto"
            >
              {subtitle}
            </motion.p>
          )}
